...
function loadCart() {
  ...
  if (savedCart) {
      ...
      console.log('No cart data in localStorage'); // Debug log
  }
}
...
function renderCart() {
  ...
  if (!cartItems) {
      console.warn('No #cart-items element found on this page'); // Debug log
      return;
  }
...
function updateTotal() {
  const cartTotal = document.getElementById("cart-total");
  if (!cartTotal) {
      console.warn('No #cart-total element found on this page'); // Debug log
      return;
  }
...
function showProductDetails(product) {
  ...
  if (!modal) {
      console.warn('No #product-modal element found on this page'); // Debug log
      return;
  }
